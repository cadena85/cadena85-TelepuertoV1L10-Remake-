                ...
                <meta content="" name="description">
                    <meta content="Mark Otto, Jacob Thornton, and Bootstrap contributors" name="author">
                        <meta content="Hugo 0.111.3" name="generator">
                            ...
                            <link href="https://getbootstrap.com/docs/5.3/examples/album/" rel="canonical">
    ...
    <body>
        ...
        <header data-bs-theme="dark">
            ...
            <div class="navbar navbar-dark bg-dark shadow-sm">
                <div class="container">
                    ...
                    <button aria-controls="navbarHeader" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-bs-target="#navbarHeader" data-bs-toggle="collapse" type="button">
        ...
        <main>
                ...
                <div class="row py-lg-5">
                    <div class="col-lg-6 col-md-8 mx-auto">
                        ...
                        <p>
                            ...
                            <a class="btn btn-secondary my-2" href="{{route('aletorios')}}">
                                Aleatorios
                            </a>
                        </p>
                    </div>
            ...
            <div class="album py-5 bg-body-tertiary">
                <div class="container">
                    <div id="gatosFavoritos" class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                        
                        <div class="col">
                            <div class="card shadow-sm">
                                <svg aria-label="Placeholder: Thumbnail" class="bd-placeholder-img card-img-top" focusable="false" height="225" preserveaspectratio="xMidYMid slice" role="img" width="100%" xmlns="http://www.w3.org/2000/svg">
                                    <title>
                                        Placeholder
                                    </title>
