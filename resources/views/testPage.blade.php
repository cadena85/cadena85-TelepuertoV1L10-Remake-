    ...
    <body>
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <button id="btn2" type="button" onclick="guardarGatoFavorito()" class="btn btn-primary">Me gusta</button>
            </div>
        </div>
        <section class="container">
            <!--button type="button" class="random-cat-button">Gato</button-->
            <button type="button" onclick="myCat()" class="random-cat-button"> Recargar (onclick-html)</button>
        </section>
        <script src="../js/gatitos.js?v5"></script>
